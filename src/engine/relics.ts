...
export const ALL_RELICS: Relic[] = [
  ...
  // Nuevas reliquias - Expansion
  {
    id: "ritmo_acelerado",
    name: "Ritmo Acelerado",
    description: "+15 score por cada accion restante al cerrar",
    trigger: "on_score",
    effect: { type: "bonus_per_action_left", value: 15 },
    rarity: "rare",
    family: "accion",
  },
  {
    id: "mano_ligera",
    name: "Mano Ligera",
    description: "Si terminas con 3+ fichas en mano, +40 score",
    trigger: "on_score",
    effect: { type: "bonus_if_tiles_in_hand", minTiles: 3, value: 40 },
    rarity: "uncommon",
    family: "accion",
  },
  {
    id: "pureza_tactica",
    name: "Pureza Tactica",
    description: "Si no usaste descartes esta ronda, x1.15 score",
    trigger: "on_score",
    effect: { type: "multiplier_if_no_discards", value: 1.15 },
    rarity: "rare",
    family: "accion",
  },
  {
    id: "colmillo_triple",
    name: "Colmillo Triple",
    description: "Cada trio de fichas identicas suma +25",
    trigger: "on_score",
    effect: { type: "bonus_per_triple", value: 25 },
    rarity: "uncommon",
    family: "numero",
  },
  {
    id: "eco_impar",
    name: "Eco Impar",
    description: "Los numeros impares otorgan +4 por aparicion",
    trigger: "on_score",
    effect: { type: "bonus_per_odd", value: 4 },
    rarity: "common",
    family: "numero",
  },
  {
    id: "simetria_perfecta",
    name: "Simetria Perfecta",
    description: "Espejo otorga x1.4 adicional",
    trigger: "on_pattern",
    effect: { type: "multiplier_if_pattern", patternId: "espejo", value: 1.4 },
    rarity: "rare",
    family: "patron",
  },
  {
    id: "cascada_dorada",
    name: "Cascada Dorada",
    description: "Escalera otorga +60 extra",
    trigger: "on_pattern",
    effect: { type: "bonus_if_pattern", patternId: "escalera", value: 60 },
    rarity: "uncommon",
    family: "patron",
  },
  {
    id: "nucleo_cero",
    name: "Nucleo Cero",
    description: "Cada 0 jugado suma +8 adicional",
    trigger: "on_score",
    effect: { type: "bonus_per_zero", value: 8 },
    rarity: "uncommon",
    family: "numero",
  },
  {
    id: "furia_final",
    name: "Furia Final",
    description: "Las ultimas 3 fichas jugadas valen x1.5",
    trigger: "on_score",
    effect: { type: "multiplier_last_tiles", count: 3, value: 1.5 },
    rarity: "rare",
    family: "accion",
  },
  {
    id: "bendicion_ancestral",
    name: "Bendicion Ancestral",
    description: "Cada patron activado suma +8 base. Stackeable.",
    trigger: "on_pattern",
    effect: { type: "bonus_per_any_pattern", value: 8 },
    rarity: "legendary",
    family: "patron",
  },
];
