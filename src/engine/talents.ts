...
export const ALL_TALENTS: Talent[] = [
  ...
  // ---- S7: capstone tier 4 (one per branch) ----
  {
    id: "apoteosis",
    branch: "score",
    tier: 4,
    name: "Apoteosis",
    description: "+5% al score total (multiplicativo, apilable con Dominio Total)",
    maxRank: 3,
    costPerRank: 5,
    effect: { type: "score_multiplier", value: 0.05 },
    requiresBranchPoints: 8,
  },
  {
    id: "memoria_perfecta",
    branch: "chain",
    ...
    description: "Al avanzar ronda conservas 2 fichas adicionales al azar",
    maxRank: 1,
    costPerRank: 5,
    effect: { type: "tile_preserve", value: 2 },
    requiresBranchPoints: 8,
  },
  {
    id: "talisman",
    ...
    tier: 4,
    name: "Talisman",
    description: "Tambien empiezas con Fortuna (+60 flat)",
    maxRank: 1,
    costPerRank: 6,
    effect: { type: "starting_relic", value: "fortuna" },
    requiresBranchPoints: 8,
  },
  {
    id: "inversionista",
    ...
    tier: 4,
    name: "Inversionista",
    description: "+15% oro ganado adicional (apilable con Mercader)",
    maxRank: 2,
    costPerRank: 4,
    effect: { type: "gold_multiplier", value: 0.15 },
    requiresBranchPoints: 8,
  },
];
