...
export const LEVEL_REWARDS: LevelReward[] = [
  ...
  { id: "lv8_relic2", level: 8, name: "Reliquia Extra", description: "Empiezas con Precision equipado", type: "starting_relic", value: "precision" },
  { id: "lv9_skin_ruby", level: 9, name: "Skin: Rubi", description: "Desbloquea el estilo Rubi para fichas", type: "tile_skin", value: "ruby" },
  { id: "lv10_golden2", level: 10, name: "Doble Dorada", description: "Dos fichas aleatorias empiezan doradas", type: "starting_golden", value: 2 },
  { id: "lv11_skin_ivory", level: 11, name: "Skin: Marfil", description: "Desbloquea el estilo Marfil clasico para fichas", type: "tile_skin", value: "ivory" },
  { id: "lv12_hand", level: 12, name: "Mano Amplia", description: "+1 ficha en la mano inicial", type: "hand_size", value: 1 },
  { id: "lv14_skin_void", level: 14, name: "Skin: Vacio", description: "Desbloquea el estilo Vacio para fichas", type: "tile_skin", value: "void" },
  { id: "lv15_gold3", level: 15, name: "Cofre de Oro", description: "Empiezas cada run con 35 de oro", type: "starting_gold", value: 35 },
  { id: "lv17_skin_neon", level: 17, name: "Skin: Neon", description: "Desbloquea el estilo Neon cibernetico para fichas", type: "tile_skin", value: "neon" },
  { id: "lv18_relic3", level: 18, name: "Tercera Reliquia", description: "Empiezas con Mano Firme equipado", type: "starting_relic", value: "mano_firme" },
